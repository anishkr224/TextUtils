    ...
    if(numberremover=="on"):
        ...
        for char in djtext:
            if char not in numbers:
                analyzed=analyzed+char
        params={'purpose':'Numbers Removed', 'analyzed_text':analyzed}
        djtext = analyzed

    if(removepunctuation != "on" and fullcaps!="on" and newlineremover!="on" and extraspaceremover!="on" and countchar != "on" and numberremover!="on"):
